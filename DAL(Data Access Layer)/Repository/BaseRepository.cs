...
namespace DAL_Data_Access_Layer_
{
    ...
    {
        protected readonly CompanyEquipModel context;
        protected DbSet<TEntity> dbSet;

        public BaseRepository(CompanyEquipModel context)
        {
        ...
        public ResultApiDto<IEnumerable<T>> Paginate<T>(IQueryable<T> query, int page = 0, int take = 0)
        {
            var result = new ResultApiDto<IEnumerable<T>>();
    ...
    public interface IRepository<TEntity>
    {
        ...
        int count();
        int SaveChanges();
        ResultApiDto<IEnumerable<T>> Paginate<T>(IQueryable<T> query, int page = 0, int take = 0);
